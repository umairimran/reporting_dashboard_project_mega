...
async def upload_facebook_file(
    client_id: uuid.UUID,
    ...
    """
    Upload Facebook data file for a client.
    
    - **client_id**: ID of the client
    - **file**: CSV or XLSX file with Facebook data
    
    File must contain columns: Date, Campaign Name, Ad Set Name, Ad Name, 
    ...
    # Process upload
    handler = FacebookUploadHandler(db)
